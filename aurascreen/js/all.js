...
document.addEventListener("mousemove", (e) => {
  if(curs != null && isIn){
    let x = e.clientX;
    let y = e.clientY;
    curs.style.left = x - 250 + "px";
    curs.style.top = y - 250 + "px";
  }
});
let isIn = false
let displayOn = document.querySelectorAll(".home-section");
displayOn.forEach((section, i) => {
  section.addEventListener("mouseover", (e) => {
    isIn = true;
    curs.classList.add("cursor-shown");
  });
  section.addEventListener("mouseleave", (e) => {
    isIn = false;
    curs.classList.remove("cursor-shown");
  });
});
